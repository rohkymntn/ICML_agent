...
- Model 2 gain-of-function recovery + matched-additive within-bin Spearman: **`feat_GB1_Olson.npz` DONE on volume (iter8).** Needs `model2_design.py` extended to write a committed result CSV (also needs the GB1 assay CSV pulled locally).
