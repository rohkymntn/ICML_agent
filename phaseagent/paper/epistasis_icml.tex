...
Model 2 (\cref{sec:model2}) is evaluated by gain-of-function recovery and the
matched-additive within-bin Spearman, with each number traced to a committed
\texttt{outputs/epistasis/model2\_oof\_*.csv} in \texttt{CLAIMS.md}; the
quantitative table is folded in once its design run artifact is committed.
